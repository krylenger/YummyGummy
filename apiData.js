...
export const dailyMealPlan = {
  meals: [
    ...
    },
    {
      ...
      servings: 1,
      sourceUrl:
        'http://www.fortheloveofcooking.net/2017/09/gruyere-slow-roasted-tomato-and-caramelized-onion-grilled-cheese.html',
    },
    {
      id: 1044995,
      imageType: 'jpg',
...
export const recipesByIngredients = [
  ...
  },
  {
    ...
    missedIngredients: [
      ...
      },
      {
        ...
        originalString: '1/3 cup softened butter',
    ...
    usedIngredients: [
      {
        ...
        originalString: '2 Granny Smith Apples (or your favorite type of apple)',
        originalName: 'Granny Smith Apples (or your favorite type of apple)',
        metaInformation: ['your favorite', '(or type of apple)'],
    ...
    missedIngredients: [
      {
        ...
        originalString: '1/2 cup Butter or margarine',
      ...
      },
      {
        ...
        originalString: 'Nuts and raisins, chopped',
    ...
    usedIngredients: [
      {
        ...
        originalString: '1 whl apple peeled, thinly sliced',
  ...
  {
    id: 640588,
    title: 'Creamy Apple Cinnamon Pockets',
    image: 'https://spoonacular.com/recipeImages/640588-312x231.jpg',
    imageType: 'jpg',
    usedIngredientCount: 2,
    missedIngredientCount: 4,
    missedIngredients: [
      ...
      },
      {
        ...
        name: 'golden raisins',
        original: '1/8 cup golden raisins',
        originalString: '1/8 cup golden raisins',
      ...
      },
      {
        ...
        name: 'puff pastry',
        original: '1 puff pastry sheet',
        originalString: '1 puff pastry sheet',
        originalName: 'puff pastry sheet',
        metaInformation: [],
        meta: [],
    ...
    usedIngredients: [
      {
        ...
        aisle: 'Produce',
        name: 'apple',
        original: '1 apple (peeled, cored, very finely chopped)',
        originalString: '1 apple (peeled, cored, very finely chopped)',
        originalName: 'apple (peeled, cored, very finely chopped)',
        metaInformation: ['cored', 'peeled', 'very finely chopped', '(, , )'],
        meta: ['cored', 'peeled', 'very finely chopped', '(, , )'],
        image: 'https://spoonacular.com/cdn/ingredients_100x100/apple.jpg',
      },
      {
        id: 1077,
        ...
        aisle: 'Milk, Eggs, Other Dairy',
        name: 'milk',
        original: '2 tbsp milk (for milk wash or if u like darker color of crust, use egg-wash)',
        originalString:
          '2 tbsp milk (for milk wash or if u like darker color of crust, use egg-wash)',
        originalName: 'milk (for milk wash or if u like darker color of crust, use egg-wash)',
        metaInformation: ['(for milk wash or if u like darker color of crust, use egg-wash)'],
        meta: ['(for milk wash or if u like darker color of crust, use egg-wash)'],
        image: 'https://spoonacular.com/cdn/ingredients_100x100/milk.png',
      },
    ],
    unusedIngredients: [],
  ...
  },
  {
    ...
    image: 'https://spoonacular.com/recipeImages/632508-312x231.jpg',
    imageType: 'jpg',
    usedIngredientCount: 2,
    missedIngredientCount: 4,
    missedIngredients: [
      {
        ...
        aisle: 'Baking',
        name: 'almond extract',
        original: '1/4 teaspoon almond extract',
        originalString: '1/4 teaspoon almond extract',
      ...
      },
      {
        ...
        aisle: 'Milk, Eggs, Other Dairy',
        name: 'almond milk',
        original: '1/4 cup almond milk',
        originalString: '1/4 cup almond milk',
      ...
      },
      {
        ...
        originalString: '3/4 teaspoon cinnamon',
        originalName: 'cinnamon',
        metaInformation: [],
        meta: [],
        image: 'https://spoonacular.com/cdn/ingredients_100x100/cinnamon.jpg',
      },
      {
        ...
        aisle: 'Cereal',
        name: 'oats',
        original: '3/4 cup oats',
        originalString: '3/4 cup oats',
        originalName: 'oats',
        metaInformation: [],
        meta: [],
    ...
    missedIngredients: [
      {
        ...
        originalString: '1 cup cold butter, cut in pieces',
        originalName: 'cold butter, cut in pieces',
        metaInformation: ['cold', 'cut in pieces'],
    ...
    usedIngredients: [
      {
        ...
        originalString: '6 apples peeled, quartered and thinly sliced',
        originalName: 'apples peeled, quartered and thinly sliced',
        metaInformation: ['peeled', 'thinly sliced', 'quartered'],
    ...
    usedIngredients: [
      {
        ...
        originalString: '3 apples – peeled & cut into wedges',
        originalName: 'apples – peeled & cut into wedges',
        metaInformation: ['peeled', 'cut into wedges'],
  ...
  },
  {
    ...
    missedIngredients: [
      ...
      },
      {
        ...
        originalString: '2 eggs, slightly beaten',
      ...
      },
      {
        ...
        originalString: '3 teaspoons vanilla (divided)',
      ...
      },
      {
        ...
        originalString: '1/2 cup chopped walnuts (optional)',
    ...
    usedIngredients: [
      {
        ...
        originalString: '3 cups peeled, chopped apples',
    ...
    usedIngredients: [
      {
        ...
        meta: ['dried'],
        image: 'https://spoonacular.com/cdn/ingredients_100x100/apple-dried.jpg',
      },
      {
        id: 1077,
        amount: 0.75,
